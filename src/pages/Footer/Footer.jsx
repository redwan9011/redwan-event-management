...
const Footer = () => {
    return (
      <div className="bg-red-500 ">
          <footer className="footer items-center justify-center p-4 text-neutral-content max-w-6xl mx-auto">
        <aside className="items-center grid-flow-col">
          ...
          <p>Copyright © 2023 - All right reserved to the Company</p>
        </aside> 
        <nav className="grid-flow-col gap-4 md:place-self-center justify-self-center pb-5 md:pb-0 md:justify-self-end">
